...
if( !class_exists( 'vx_crmperks_notice_vxc_infusionsoft' )):
class vx_crmperks_notice_vxc_infusionsoft extends vxc_infusionsoft{
public $plugin_url="https://www.crmperks.com";
public $review_link='https://wordpress.org/support/plugin/wp-infusionsoft-woocommerce/reviews/?filter=5#new-post';
...
<p><i class="fa fa-check"></i> Send WooCommerce Orders to Infusionsoft Orders.</p>
<p><i class="fa fa-check"></i> Infusionsoft custom fields.</p>
<p><i class="fa fa-check"></i> Infusionsoft Affiliates Tracking.</p>
<p><i class="fa fa-check"></i> Assign Tags to Contacts based on different conditions.</p>
<p><i class="fa fa-check"></i> Infusionsoft Phone Number fields.</p>
<p><i class="fa fa-check"></i> Assign Lead Source to Contact in Infusionsoft.</p>
...
public function review_notice() { 
 $install_time=get_option($this->id."_install_data");
   ...
   if(empty($install_time['time'])){ 
    ...
    $time=current_time( 'timestamp' , 1 )-(72000);
 ...
 if(!empty($install_time) && is_array($install_time) && !empty($install_time['time']) && empty($install_time['review_closed'])){ 
  ...
  <p><?php echo sprintf(__( 'You\'ve been using WooCommerce Infusionsoft Plugin for some time now; we hope you love it!.%s If you do, please %s leave us a %s rating on WordPress.org%s to help us spread the word and boost our motivation.','contact-form-entries'),'<br/>','<a href="'.$this->review_link.'" target="_blank" rel="noopener noreferrer">','&#9733;&#9733;&#9733;&#9733;&#9733;','</a>'); ?></p>
...
<p><b><a href="https://wordpress.org/plugins/gf-infusionsoft-crmperks/" target="_blank">Gravity Forms Infusionsoft Plugin</a></b> allows you to quickly integrate Gravity forms entries with Infusionsoft CRM.</p>
...
new vx_crmperks_notice_vxc_infusionsoft();
endif;
